...
public enum EnumFacing {
   ...
   private EnumFacing(String p_i1367_1_, int p_i1367_2_, int p_i1367_3_, int p_i1367_4_, int p_i1367_5_, int p_i1367_6_, int p_i1367_7_) {
      this.field_82603_g = p_i1367_3_;
      this.field_82613_h = p_i1367_4_;
      this.field_82614_i = p_i1367_5_;
      this.field_82611_j = p_i1367_6_;
      this.field_82612_k = p_i1367_7_;
   }
