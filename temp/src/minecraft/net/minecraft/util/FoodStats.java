...
public class FoodStats {
   ...
   public void func_75118_a(EntityPlayer p_75118_1_) {
      EnumDifficulty var2 = p_75118_1_.field_70170_p.field_73013_u;
      ...
      if(p_75118_1_.field_70170_p.func_82736_K().func_82766_b("naturalRegeneration") && this.field_75127_a >= 18 && p_75118_1_.func_70996_bM()) {
         ...
         ++this.field_75123_d;
         if(this.field_75123_d >= 80) {
            if(p_75118_1_.func_110143_aJ() > 10.0F || var2 == EnumDifficulty.HARD || p_75118_1_.func_110143_aJ() > 1.0F && var2 == EnumDifficulty.NORMAL) {
