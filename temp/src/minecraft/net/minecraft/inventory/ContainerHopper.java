...
public class ContainerHopper extends Container {
   ...
   public ContainerHopper(InventoryPlayer p_i1814_1_, IInventory p_i1814_2_) {
      ...
      int var4;
      for(var4 = 0; var4 < p_i1814_2_.func_70302_i_(); ++var4) {
         this.func_75146_a(new Slot(p_i1814_2_, var4, 44 + var4 * 18, 20));
      }

      for(var4 = 0; var4 < 3; ++var4) {
         for(int var5 = 0; var5 < 9; ++var5) {
            this.func_75146_a(new Slot(p_i1814_1_, var5 + var4 * 9 + 9, 8 + var5 * 18, var4 * 18 + var3));
         }
      }

      for(var4 = 0; var4 < 9; ++var4) {
         this.func_75146_a(new Slot(p_i1814_1_, var4, 8 + var4 * 18, 58 + var3));
      }
