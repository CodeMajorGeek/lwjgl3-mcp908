...
public class ContainerRepair extends Container {
   ...
   public ContainerRepair(InventoryPlayer p_i1800_1_, final World p_i1800_2_, final int p_i1800_3_, final int p_i1800_4_, final int p_i1800_5_, EntityPlayer p_i1800_6_) {
      ...
      this.func_75146_a(new Slot(this.field_82852_f, 2, 134, 47) {
         ...
         public void func_82870_a(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
            ...
            if(!p_82870_1_.field_71075_bZ.field_75098_d && !p_i1800_2_.field_72995_K && p_i1800_2_.func_147439_a(p_i1800_3_, p_i1800_4_, p_i1800_5_) == Blocks.field_150467_bQ && p_82870_1_.func_70681_au().nextFloat() < 0.12F) {
               int var6 = p_i1800_2_.func_72805_g(p_i1800_3_, p_i1800_4_, p_i1800_5_);
               int var4 = var6 & 3;
               int var5 = var6 >> 2;
               ++var5;
               if(var5 > 2) {
                  ...
                  p_i1800_2_.func_72921_c(p_i1800_3_, p_i1800_4_, p_i1800_5_, var4 | var5 << 2, 2);
      ...
      for(var7 = 0; var7 < 3; ++var7) {
         for(int var8 = 0; var8 < 9; ++var8) {
            this.func_75146_a(new Slot(p_i1800_1_, var8 + var7 * 9 + 9, 8 + var8 * 18, 84 + var7 * 18));
         }
      }

      for(var7 = 0; var7 < 9; ++var7) {
         this.func_75146_a(new Slot(p_i1800_1_, var7, 8 + var7 * 18, 142));
      }
   ...
   public boolean func_75145_c(EntityPlayer p_75145_1_) {
      return this.field_82860_h.func_147439_a(this.field_82861_i, this.field_82858_j, this.field_82859_k) != Blocks.field_150467_bQ?false:p_75145_1_.func_70092_e((double)this.field_82861_i + 0.5D, (double)this.field_82858_j + 0.5D, (double)this.field_82859_k + 0.5D) <= 64.0D;
   }
