   ...
   public ContainerEnchantment(InventoryPlayer p_i1811_1_, World p_i1811_2_, int p_i1811_3_, int p_i1811_4_, int p_i1811_5_) {
      ...
      for(var6 = 0; var6 < 3; ++var6) {
         for(int var7 = 0; var7 < 9; ++var7) {
            this.func_75146_a(new Slot(p_i1811_1_, var7 + var6 * 9 + 9, 8 + var7 * 18, 84 + var6 * 18));
         }
      }

      for(var6 = 0; var6 < 9; ++var6) {
         this.func_75146_a(new Slot(p_i1811_1_, var6, 8 + var6 * 18, 142));
      }
            ...
            if(!this.field_75172_h.field_72995_K) {
               ...
               for(var4 = -1; var4 <= 1; ++var4) {
                  for(int var5 = -1; var5 <= 1; ++var5) {
                     if((var4 != 0 || var5 != 0) && this.field_75172_h.func_147437_c(this.field_75173_i + var5, this.field_75170_j, this.field_75171_k + var4) && this.field_75172_h.func_147437_c(this.field_75173_i + var5, this.field_75170_j + 1, this.field_75171_k + var4)) {
                        if(this.field_75172_h.func_147439_a(this.field_75173_i + var5 * 2, this.field_75170_j, this.field_75171_k + var4 * 2) == Blocks.field_150342_X) {
                           ++var3;
                        }

                        if(this.field_75172_h.func_147439_a(this.field_75173_i + var5 * 2, this.field_75170_j + 1, this.field_75171_k + var4 * 2) == Blocks.field_150342_X) {
                           ++var3;
                        }

                        if(var5 != 0 && var4 != 0) {
                           if(this.field_75172_h.func_147439_a(this.field_75173_i + var5 * 2, this.field_75170_j, this.field_75171_k + var4) == Blocks.field_150342_X) {
                              ++var3;
                           }

                           if(this.field_75172_h.func_147439_a(this.field_75173_i + var5 * 2, this.field_75170_j + 1, this.field_75171_k + var4) == Blocks.field_150342_X) {
                              ++var3;
                           }

                           if(this.field_75172_h.func_147439_a(this.field_75173_i + var5, this.field_75170_j, this.field_75171_k + var4 * 2) == Blocks.field_150342_X) {
                              ++var3;
                           }

                           if(this.field_75172_h.func_147439_a(this.field_75173_i + var5, this.field_75170_j + 1, this.field_75171_k + var4 * 2) == Blocks.field_150342_X) {
                              ++var3;
                           }
                        }
                     }
