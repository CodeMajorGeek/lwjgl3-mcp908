...
public class BlockOldLog extends BlockLog {
   ...
   public void func_149651_a(IIconRegister p_149651_1_) {
      ...
      for(int var2 = 0; var2 < this.field_150167_a.length; ++var2) {
         this.field_150167_a[var2] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150168_M[var2]);
         this.field_150166_b[var2] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150168_M[var2] + "_top");
      }
