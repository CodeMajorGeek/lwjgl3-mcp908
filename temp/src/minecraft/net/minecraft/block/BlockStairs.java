...
public class BlockStairs extends Block {
   ...
   public void func_150147_e(IBlockAccess p_150147_1_, int p_150147_2_, int p_150147_3_, int p_150147_4_) {
      int var5 = p_150147_1_.func_72805_g(p_150147_2_, p_150147_3_, p_150147_4_);
      if((var5 & 4) != 0) {
   ...
   private boolean func_150146_f(IBlockAccess p_150146_1_, int p_150146_2_, int p_150146_3_, int p_150146_4_, int p_150146_5_) {
      ...
      return func_150148_a(var6) && p_150146_1_.func_72805_g(p_150146_2_, p_150146_3_, p_150146_4_) == p_150146_5_;
   }

   public boolean func_150145_f(IBlockAccess p_150145_1_, int p_150145_2_, int p_150145_3_, int p_150145_4_) {
      int var5 = p_150145_1_.func_72805_g(p_150145_2_, p_150145_3_, p_150145_4_);
      int var6 = var5 & 3;
      float var7 = 0.5F;
      float var8 = 1.0F;
      if((var5 & 4) != 0) {
      ...
      if(var6 == 0) {
         ...
         var15 = p_150145_1_.func_72805_g(p_150145_2_ + 1, p_150145_3_, p_150145_4_);
         ...
         var15 = p_150145_1_.func_72805_g(p_150145_2_, p_150145_3_, p_150145_4_ + 1);
         if(func_150148_a(var14) && (var5 & 4) == (var15 & 4)) {
            var16 = var15 & 3;
   ...
   public boolean func_150144_g(IBlockAccess p_150144_1_, int p_150144_2_, int p_150144_3_, int p_150144_4_) {
      int var5 = p_150144_1_.func_72805_g(p_150144_2_, p_150144_3_, p_150144_4_);
      int var6 = var5 & 3;
      float var7 = 0.5F;
      float var8 = 1.0F;
      if((var5 & 4) != 0) {
      ...
      if(var6 == 0) {
         ...
         var15 = p_150144_1_.func_72805_g(p_150144_2_ - 1, p_150144_3_, p_150144_4_);
         if(func_150148_a(var14) && (var5 & 4) == (var15 & 4)) {
            var16 = var15 & 3;
         ...
         var15 = p_150144_1_.func_72805_g(p_150144_2_, p_150144_3_, p_150144_4_ - 1);
         if(func_150148_a(var14) && (var5 & 4) == (var15 & 4)) {
            var11 = 0.0F;
            var12 = 0.5F;
            var16 = var15 & 3;
   ...
   public void func_149689_a(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_) {
      ...
      int var8 = p_149689_1_.func_72805_g(p_149689_2_, p_149689_3_, p_149689_4_) & 4;
      if(var7 == 0) {
         p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 2 | var8, 2);
      }

      if(var7 == 1) {
         p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 1 | var8, 2);
      }

      if(var7 == 2) {
         p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 3 | var8, 2);
      }

      if(var7 == 3) {
         p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 0 | var8, 2);
      }
   ...
   public MovingObjectPosition func_149731_a(World p_149731_1_, int p_149731_2_, int p_149731_3_, int p_149731_4_, Vec3 p_149731_5_, Vec3 p_149731_6_) {
      ...
      int var8 = p_149731_1_.func_72805_g(p_149731_2_, p_149731_3_, p_149731_4_);
      int var9 = var8 & 3;
      ...
      for(int var17 = 0; var17 < var16; ++var17) {
         ...
         if(var18 != null) {
            double var19 = var18.field_72307_f.func_72436_e(p_149731_6_);
            if(var19 > var24) {
               var22 = var18;
               var24 = var19;
            }
