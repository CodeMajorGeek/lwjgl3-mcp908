...
public class BlockPressurePlate extends BlockBasePressurePlate {
   ...
   protected int func_150065_e(World p_150065_1_, int p_150065_2_, int p_150065_3_, int p_150065_4_) {
      ...
      if(this.field_150069_a == BlockPressurePlate.Sensitivity.everything) {
         var5 = p_150065_1_.func_72839_b((Entity)null, this.func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_));
      }

      if(this.field_150069_a == BlockPressurePlate.Sensitivity.mobs) {
         var5 = p_150065_1_.func_72872_a(EntityLivingBase.class, this.func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_));
      }

      if(this.field_150069_a == BlockPressurePlate.Sensitivity.players) {
         var5 = p_150065_1_.func_72872_a(EntityPlayer.class, this.func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_));
      }
