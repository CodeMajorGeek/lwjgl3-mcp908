   ...
   public void func_149651_a(IIconRegister p_149651_1_) {
      ...
      for(int var2 = 0; var2 < this.field_150192_M.length; ++var2) {
         if(field_150189_b[var2] == null) {
            ...
            this.field_150192_M[var2] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150189_b[var2]);
         }
      }

      this.field_150190_P = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + "top");
      this.field_150193_N = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + "chiseled_top");
      this.field_150194_O = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + "lines_top");
      this.field_150188_Q = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + "bottom");
   }
