...
public class RealmsEditBox {
   ...
   public RealmsEditBox(int p_i1111_1_, int p_i1111_2_, int p_i1111_3_, int p_i1111_4_) {
      this(Minecraft.func_71410_x().field_71466_p, p_i1111_1_, p_i1111_2_, p_i1111_3_, p_i1111_4_);
   }
   ...
   public void insertText(String p_insertText_1_) {
      String var2 = "";
      String var3 = ChatAllowedCharacters.func_71565_a(p_insertText_1_);
      ...
      if(!this.inFocus) {
         ...
         default:
            ...
            case 211:
               ...
               return true;
            default:
               if(ChatAllowedCharacters.func_71566_a(p_keyPressed_1_)) {
                  if(this.isEditable) {
   ...
   public void render() {
      if(this.isVisible()) {
         ...
         if(var4.length() > 0 && var5 && var2 < var4.length()) {
            this.font.func_78261_a(var4.substring(var2), var9, var8, var1);
         }
   ...
   private void renderHighlight(int p_renderHighlight_1_, int p_renderHighlight_2_, int p_renderHighlight_3_, int p_renderHighlight_4_) {
      ...
      GL11.glLogicOp(5387);
      var6.func_78382_b();
      var6.func_78377_a((double)p_renderHighlight_1_, (double)p_renderHighlight_4_, 0.0D);
      var6.func_78377_a((double)p_renderHighlight_3_, (double)p_renderHighlight_4_, 0.0D);
      var6.func_78377_a((double)p_renderHighlight_3_, (double)p_renderHighlight_2_, 0.0D);
      var6.func_78377_a((double)p_renderHighlight_1_, (double)p_renderHighlight_2_, 0.0D);
      var6.func_78381_a();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
