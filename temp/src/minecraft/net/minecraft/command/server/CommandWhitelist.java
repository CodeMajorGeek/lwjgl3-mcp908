   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length >= 1) {
         ...
         if(p_71515_2_[0].equals("list")) {
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.whitelist.list", new Object[]{Integer.valueOf(var3.func_71203_ab().func_152598_l().length), Integer.valueOf(var3.func_71203_ab().func_72373_m().length)}));
            String[] var5 = var3.func_71203_ab().func_152598_l();
            p_71515_1_.func_145747_a(new ChatComponentText(func_71527_a(var5)));
            return;
         }
         ...
         if(p_71515_2_[0].equals("add")) {
            ...
            var3.func_71203_ab().func_152601_d(var4);
         ...
         if(p_71515_2_[0].equals("remove")) {
            ...
            var4 = var3.func_71203_ab().func_152599_k().func_152706_a(p_71515_2_[1]);
            if(var4 == null) {
