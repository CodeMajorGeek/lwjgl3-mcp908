...
public class CommandPardonPlayer extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length == 1 && p_71515_2_[0].length() > 0) {
         ...
         GameProfile var4 = var3.func_71203_ab().func_152608_h().func_152703_a(p_71515_2_[0]);
         if(var4 == null) {
   ...
   public List func_71516_a(ICommandSender p_71516_1_, String[] p_71516_2_) {
      return p_71516_2_.length == 1?func_71530_a(p_71516_2_, MinecraftServer.func_71276_C().func_71203_ab().func_152608_h().func_152685_a()):null;
   }
}
