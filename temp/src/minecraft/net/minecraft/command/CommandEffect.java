      ...
      if(p_71515_2_.length < 2) {
         ...
         if(p_71515_2_[1].equals("clear")) {
            ...
            if(var6 == 0) {
               ...
               func_152373_a(p_71515_1_, this, "commands.effect.success.removed", new Object[]{new ChatComponentTranslation(Potion.field_76425_a[var4].func_76393_a(), new Object[0]), var3.func_70005_c_()});
            } else {
               PotionEffect var8 = new PotionEffect(var4, var5, var7);
               var3.func_70690_d(var8);
               func_152373_a(p_71515_1_, this, "commands.effect.success", new Object[]{new ChatComponentTranslation(var8.func_76453_d(), new Object[0]), Integer.valueOf(var4), Integer.valueOf(var7), var3.func_70005_c_(), Integer.valueOf(var6)});
            }
         }
