...
public class GuiIngame extends Gui {
   ...
   public void func_73830_a(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_) {
      ...
      if(this.field_73839_d.field_71439_g.func_110317_t()) {
         ...
         var15 = var7 - 32 + 3;
         this.func_73729_b(var11, var15, 0, 84, var38, 5);
         if(var14 > 0) {
         ...
         if(var12 > 0) {
            var38 = 182;
            var14 = (int)(this.field_73839_d.field_71439_g.field_71106_cc * (float)(var38 + 1));
            var15 = var7 - 32 + 3;
            this.func_73729_b(var11, var15, 0, 64, var38, 5);
            if(var14 > 0) {
         ...
         if(this.field_73839_d.field_71439_g.field_71068_ca > 0) {
            ...
            String var43 = "" + this.field_73839_d.field_71439_g.field_71068_ca;
            var16 = (var6 - var8.func_78256_a(var43)) / 2;
            var17 = var7 - 31 - 4;
            boolean var18 = false;
            var8.func_78276_b(var43, var16 + 1, var17, 0);
            var8.func_78276_b(var43, var16 - 1, var17, 0);
            var8.func_78276_b(var43, var16, var17 + 1, 0);
            var8.func_78276_b(var43, var16, var17 - 1, 0);
            var8.func_78276_b(var43, var16, var17, var14);
            this.field_73839_d.field_71424_I.func_76319_b();
         }
      }
      ...
      if(this.field_73839_d.field_71474_y.field_92117_D) {
         ...
         if(this.field_92017_k > 0 && this.field_92016_l != null) {
            ...
            var13 = (var6 - var8.func_78256_a(var35)) / 2;
            var14 = var7 - 59;
            if(!this.field_73839_d.field_71442_b.func_78755_b()) {
               var14 += 14;
            }
            ...
            if(var15 > 0) {
               ...
               GL11.glEnable(3042);
               OpenGlHelper.func_148821_a(770, 771, 1, 0);
               var8.func_78261_a(var35, var13, var14, 16777215 + (var15 << 24));
               GL11.glDisable(3042);
               GL11.glPopMatrix();
            }
         }
      ...
      if(this.field_73839_d.func_71355_q()) {
         ...
         if(this.field_73839_d.field_71441_e.func_82737_E() >= 120500L) {
            var35 = I18n.func_135052_a("demo.demoExpired", new Object[0]);
         } else {
            var35 = I18n.func_135052_a("demo.remainingTime", new Object[]{StringUtils.func_76337_a((int)(120500L - this.field_73839_d.field_71441_e.func_82737_E()))});
         }

         var13 = var8.func_78256_a(var35);
         var8.func_78261_a(var35, var6 - var13 - 10, 5, 16777215);
         this.field_73839_d.field_71424_I.func_76319_b();
      }
      ...
      ScoreObjective var37 = this.field_73839_d.field_71441_e.func_96441_U().func_96539_a(1);
      if(var37 != null) {
      ...
      this.field_73839_d.field_71424_I.func_76319_b();
      GL11.glPopMatrix();
      var37 = this.field_73839_d.field_71441_e.func_96441_U().func_96539_a(0);
      if(this.field_73839_d.field_71474_y.field_74321_H.func_151470_d() && (!this.field_73839_d.func_71387_A() || this.field_73839_d.field_71439_g.field_71174_a.field_147303_b.size() > 1 || var37 != null)) {
         this.field_73839_d.field_71424_I.func_76320_a("playerList");
         NetHandlerPlayClient var40 = this.field_73839_d.field_71439_g.field_71174_a;
         List var42 = var40.field_147303_b;
         var15 = var40.field_147304_c;
         var16 = var15;
         ...
         for(var21 = 0; var21 < var15; ++var21) {
            ...
            if(var21 < var42.size()) {
               ...
               if(var37 != null) {
                  ...
                  if(var28 - var27 > 5) {
                     Score var29 = var37.func_96682_a().func_96529_a(var48.field_78831_a, var37);
