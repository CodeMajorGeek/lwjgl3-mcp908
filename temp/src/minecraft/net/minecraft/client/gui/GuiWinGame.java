...
public class GuiWinGame extends GuiScreen {
   ...
   private void func_146575_b(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      var4.func_78374_a(0.0D, (double)this.field_146295_m, (double)this.field_73735_i, 0.0D, (double)(var6 * var8));
      ...
      for(var10 = 0; var10 < this.field_146582_i.size(); ++var10) {
         ...
         if((float)var9 + var8 + 12.0F + 8.0F > 0.0F && (float)var9 + var8 < (float)this.field_146295_m) {
            ...
            if(var12.startsWith("[C]")) {
               this.field_146289_q.func_78261_a(var12.substring(3), var6 + (var5 - this.field_146289_q.func_78256_a(var12.substring(3))) / 2, var9, 16777215);
            } else {
               this.field_146289_q.field_78289_c.setSeed((long)var10 * 4238972211L + (long)(this.field_146581_h / 4));
               this.field_146289_q.func_78261_a(var12, var6, var9, 16777215);
            }
         }
