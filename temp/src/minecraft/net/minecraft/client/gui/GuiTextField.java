...
public class GuiTextField extends Gui {
   ...
   public void func_146194_f() {
      if(this.func_146176_q()) {
         ...
         if(var4.length() > 0 && var5 && var2 < var4.length()) {
            this.field_146211_a.func_78261_a(var4.substring(var2), var9, var8, var1);
         }
   ...
   private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
      ...
      GL11.glLogicOp(5387);
      var6.func_78382_b();
      var6.func_78377_a((double)p_146188_1_, (double)p_146188_4_, 0.0D);
      var6.func_78377_a((double)p_146188_3_, (double)p_146188_4_, 0.0D);
      var6.func_78377_a((double)p_146188_3_, (double)p_146188_2_, 0.0D);
      var6.func_78377_a((double)p_146188_1_, (double)p_146188_2_, 0.0D);
      var6.func_78381_a();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
