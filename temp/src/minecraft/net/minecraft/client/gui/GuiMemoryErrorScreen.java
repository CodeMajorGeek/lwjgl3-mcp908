...
public class GuiMemoryErrorScreen extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(new GuiOptionButton(0, this.field_146294_l / 2 - 155, this.field_146295_m / 4 + 120 + 12, I18n.func_135052_a("gui.toMenu", new Object[0])));
      this.field_146292_n.add(new GuiOptionButton(1, this.field_146294_l / 2 - 155 + 160, this.field_146295_m / 4 + 120 + 12, I18n.func_135052_a("menu.quit", new Object[0])));
   }
