      ...
      private void func_148237_a(boolean p_148237_1_) {
         ...
         while(var7.hasNext()) {
            ...
            if(!p_148237_1_ || var8.field_76216_a == 1) {
               ...
               var4.func_78382_b();
               var4.func_78374_a(-1.0D, 1.0D, (double)((float)var6 * 0.001F), (double)var9, (double)var10);
               var4.func_78374_a(1.0D, 1.0D, (double)((float)var6 * 0.001F), (double)var11, (double)var10);
               var4.func_78374_a(1.0D, -1.0D, (double)((float)var6 * 0.001F), (double)var11, (double)var12);
               var4.func_78374_a(-1.0D, -1.0D, (double)((float)var6 * 0.001F), (double)var9, (double)var12);
               var4.func_78381_a();
               GL11.glPopMatrix();
               ++var6;
            }
