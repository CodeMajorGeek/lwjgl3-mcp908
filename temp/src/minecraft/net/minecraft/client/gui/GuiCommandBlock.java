...
public class GuiCommandBlock extends GuiScreen {
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.randomPlayer", new Object[0]), this.field_146294_l / 2 - 150, var4 + var7++ * this.field_146289_q.field_78288_b, 10526880);
      this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.allPlayers", new Object[0]), this.field_146294_l / 2 - 150, var4 + var7++ * this.field_146289_q.field_78288_b, 10526880);
      if(this.field_146486_g.func_146179_b().length() > 0) {
         int var6 = var4 + var7 * this.field_146289_q.field_78288_b + 20;
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("advMode.previousOutput", new Object[0]), this.field_146294_l / 2 - 150, var6, 10526880);
