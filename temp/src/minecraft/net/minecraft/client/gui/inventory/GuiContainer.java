   ...
   private void func_146977_a(Slot p_146977_1_) {
      ...
      if(p_146977_1_ == this.field_147005_v && this.field_147012_x != null && this.field_147004_w && var4 != null) {
         ...
         if(Container.func_94527_a(p_146977_1_, var7, true) && this.field_147002_h.func_94531_b(p_146977_1_)) {
            ...
            if(var4.field_77994_a > p_146977_1_.func_75219_a()) {
               var8 = EnumChatFormatting.YELLOW + "" + p_146977_1_.func_75219_a();
               var4.field_77994_a = p_146977_1_.func_75219_a();
            }
         } else {
      ...
      if(var4 == null) {
         IIcon var9 = p_146977_1_.func_75212_b();
         if(var9 != null) {
            GL11.glDisable(2896);
