...
public abstract class Render {
         ...
         for(int var32 = var20; var32 <= var21; ++var32) {
            for(int var33 = var22; var33 <= var23; ++var33) {
               ...
               if(var34.func_149688_o() != Material.field_151579_a && var10.func_72957_l(var31, var32, var33) > 3) {
                  this.func_147907_a(var34, p_76975_2_, p_76975_4_ + (double)p_76975_1_.func_70053_R(), p_76975_6_, var31, var32, var33, p_76975_8_, var11, var24, var26 + (double)p_76975_1_.func_70053_R(), var28);
               }
            }
         }
      }
   ...
   private void func_147907_a(Block p_147907_1_, double p_147907_2_, double p_147907_4_, double p_147907_6_, int p_147907_8_, int p_147907_9_, int p_147907_10_, float p_147907_11_, float p_147907_12_, double p_147907_13_, double p_147907_15_, double p_147907_17_) {
      ...
      if(p_147907_1_.func_149686_d()) {
         double var20 = ((double)p_147907_11_ - (p_147907_4_ - ((double)p_147907_9_ + p_147907_15_)) / 2.0D) * 0.5D * (double)this.func_76982_b().func_72801_o(p_147907_8_, p_147907_9_, p_147907_10_);
         if(var20 >= 0.0D) {
            if(var20 > 1.0D) {
               var20 = 1.0D;
            }
   ...
   protected void func_147906_a(Entity p_147906_1_, String p_147906_2_, double p_147906_3_, double p_147906_5_, double p_147906_7_, int p_147906_9_) {
      ...
      if(var10 <= (double)(p_147906_9_ * p_147906_9_)) {
         ...
         GL11.glDisable(3553);
         var15.func_78382_b();
         int var17 = var12.func_78256_a(p_147906_2_) / 2;
         ...
         var15.func_78381_a();
         GL11.glEnable(3553);
         var12.func_78276_b(p_147906_2_, -var12.func_78256_a(p_147906_2_) / 2, var16, 553648127);
         GL11.glEnable(2929);
         GL11.glDepthMask(true);
         var12.func_78276_b(p_147906_2_, -var12.func_78256_a(p_147906_2_) / 2, var16, -1);
         GL11.glEnable(2896);
         GL11.glDisable(3042);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         GL11.glPopMatrix();
