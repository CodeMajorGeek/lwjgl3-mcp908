...
public class RenderDragon extends RenderLiving {
   ...
   protected void func_77043_a(EntityDragon p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
      float var5 = (float)p_77043_1_.func_70974_a(7, p_77043_4_)[0];
      float var6 = (float)(p_77043_1_.func_70974_a(5, p_77043_4_)[1] - p_77043_1_.func_70974_a(10, p_77043_4_)[1]);
      GL11.glRotatef(-var5, 0.0F, 1.0F, 0.0F);
      GL11.glRotatef(var6 * 10.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.0F, 0.0F, 1.0F);
      if(p_77043_1_.field_70725_aQ > 0) {
         float var7 = ((float)p_77043_1_.field_70725_aQ + p_77043_4_ - 1.0F) / 20.0F * 1.6F;
         var7 = MathHelper.func_76129_c(var7);
         if(var7 > 1.0F) {
            var7 = 1.0F;
         }

         GL11.glRotatef(var7 * this.func_77037_a(p_77043_1_), 0.0F, 0.0F, 1.0F);
      }
   ...
   public void func_76986_a(EntityDragon p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      if(p_76986_1_.field_70992_bH != null) {
         float var10 = (float)p_76986_1_.field_70992_bH.field_70261_a + p_76986_9_;
         float var11 = MathHelper.func_76126_a(var10 * 0.2F) / 2.0F + 0.5F;
         var11 = (var11 * var11 + var11) * 0.2F;
         float var12 = (float)(p_76986_1_.field_70992_bH.field_70165_t - p_76986_1_.field_70165_t - (p_76986_1_.field_70169_q - p_76986_1_.field_70165_t) * (double)(1.0F - p_76986_9_));
         float var13 = (float)((double)var11 + p_76986_1_.field_70992_bH.field_70163_u - 1.0D - p_76986_1_.field_70163_u - (p_76986_1_.field_70167_r - p_76986_1_.field_70163_u) * (double)(1.0F - p_76986_9_));
         float var14 = (float)(p_76986_1_.field_70992_bH.field_70161_v - p_76986_1_.field_70161_v - (p_76986_1_.field_70166_s - p_76986_1_.field_70161_v) * (double)(1.0F - p_76986_9_));
         ...
         float var18 = 0.0F - ((float)p_76986_1_.field_70173_aa + p_76986_9_) * 0.01F;
         float var19 = MathHelper.func_76129_c(var12 * var12 + var13 * var13 + var14 * var14) / 32.0F - ((float)p_76986_1_.field_70173_aa + p_76986_9_) * 0.01F;
   ...
   protected void func_77029_c(EntityDragon p_77029_1_, float p_77029_2_) {
      ...
      if(p_77029_1_.field_70995_bG > 0) {
         RenderHelper.func_74518_a();
         float var4 = ((float)p_77029_1_.field_70995_bG + p_77029_2_) / 200.0F;
         float var5 = 0.0F;
         if(var4 > 0.8F) {
            var5 = (var4 - 0.8F) / 0.2F;
         }
