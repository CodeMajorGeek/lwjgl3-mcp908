...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void func_78464_a() {
      ...
      var2 = (float)this.field_78531_r.field_71474_y.field_151451_c / 16.0F;
      ...
      if(var2.func_70608_bn()) {
         ...
         if(this.field_78531_r.field_71474_y.field_74325_U) {
            ...
            for(int var20 = 0; var20 < 8; ++var20) {
               ...
               var22 *= 0.1F;
               var23 *= 0.1F;
               MovingObjectPosition var24 = this.field_78531_r.field_71441_e.func_72933_a(Vec3.func_72443_a(var4 + (double)var21, var6 + (double)var22, var8 + (double)var23), Vec3.func_72443_a(var4 - var14 + (double)var21 + (double)var23, var6 - var18 + (double)var22, var8 - var16 + (double)var23));
               if(var24 != null) {
   ...
   private void func_78466_h(float p_78466_1_) {
      ...
      float var11;
      if(this.field_78531_r.field_71474_y.field_151451_c >= 4) {
         Vec3 var10 = MathHelper.func_76126_a(var2.func_72929_e(p_78466_1_)) > 0.0F?Vec3.func_72443_a(-1.0D, 0.0D, 0.0D):Vec3.func_72443_a(1.0D, 0.0D, 0.0D);
