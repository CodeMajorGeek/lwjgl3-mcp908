...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream {
   ...
   public TwitchStream(Minecraft p_i1012_1_, final String p_i1012_2_) {
      ...
      if(Strings.isNotEmpty(p_i1012_2_) && OpenGlHelper.field_148823_f) {
         Thread var3 = new Thread("Twitch authenticator") {
            ...
            public void run() {
               try {
                  URL var1 = new URL("https://api.twitch.tv/kraken?oauth_token=" + URLEncoder.encode(p_i1012_2_, "UTF-8"));
   ...
   public void func_152922_k() {
      if(this.field_152951_c.func_152850_m() && !this.field_152951_c.func_152839_p()) {
         ...
         if(var7) {
            ...
            GL11.glPushMatrix();
            GL11.glLoadIdentity();
            GL11.glOrtho(0.0D, (double)this.field_152956_h.field_147621_c, (double)this.field_152956_h.field_147618_d, 0.0D, 1000.0D, 3000.0D);
            ...
            var14.func_78382_b();
            var14.func_78374_a(0.0D, (double)var11, 0.0D, 0.0D, (double)var13);
            var14.func_78374_a((double)var10, (double)var11, 0.0D, (double)var12, (double)var13);
            var14.func_78374_a((double)var10, 0.0D, 0.0D, (double)var12, 0.0D);
            var14.func_78374_a(0.0D, 0.0D, 0.0D, 0.0D, 0.0D);
            var14.func_78381_a();
            var9.func_147606_d();
            GL11.glPopMatrix();
            GL11.glMatrixMode(5889);
   ...
   public void func_152892_c(ErrorCode p_152892_1_) {
      ...
      if(p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED) {
         ...
         var2.func_150256_b().func_150228_d(Boolean.valueOf(true));
   ...
   public void func_152903_a(ChatMessage[] p_152903_1_) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         if(this.func_152940_a(var5.modes, var5.subscriptions, this.field_152953_e.field_71474_y.field_152409_S)) {
            ...
            ChatComponentTranslation var7 = new ChatComponentTranslation("chat.stream." + (var5.action?"emote":"text"), new Object[]{this.field_152954_f, var6, EnumChatFormatting.func_110646_a(var5.message)});
            if(var5.action) {
               var7.func_150256_b().func_150217_b(Boolean.valueOf(true));
            }

            ChatComponentText var8 = new ChatComponentText("");
            var8.func_150257_a(new ChatComponentTranslation("stream.userinfo.chatTooltip", new Object[0]));
