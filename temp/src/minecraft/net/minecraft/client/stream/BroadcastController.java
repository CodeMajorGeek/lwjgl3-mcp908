...
public class BroadcastController implements IStatCallbacks, IStreamCallbacks {
   ...
   public void func_152846_a(FrameBuffer p_152846_1_) {
      try {
         ...
         var4.func_71507_a("Buffer", p_152846_1_);
         var4.func_71507_a("Free buffer count", Integer.valueOf(this.field_152875_k.size()));
         var4.func_71507_a("Capture buffer count", Integer.valueOf(this.field_152874_j.size()));
