...
public class Minecraft implements IPlayerUsage {
   ...
   private void func_71366_a(long p_71366_1_) {
      if(this.field_71424_I.field_76327_a) {
         ...
         for(int var20 = 0; var20 < var3.size(); ++var20) {
            ...
            this.field_71466_p.func_78261_a(var22, var7 - var6, var8 + var6 / 2 + var20 * 8 + 20, var21.func_76329_a());
            this.field_71466_p.func_78261_a(var22 = var18.format(var21.field_76332_a) + "%", var7 + var6 - 50 - this.field_71466_p.func_78256_a(var22), var8 + var6 / 2 + var20 * 8 + 20, var21.func_76329_a());
            this.field_71466_p.func_78261_a(var22 = var18.format(var21.field_76330_b) + "%", var7 + var6 - this.field_71466_p.func_78256_a(var22), var8 + var6 / 2 + var20 * 8 + 20, var21.func_76329_a());
         }
   ...
   public void func_71407_l() {
      ...
      if(this.field_71462_r == null || this.field_71462_r.field_146291_p) {
         ...
         while(Mouse.next()) {
            ...
            long var11 = func_71386_F() - this.field_71423_H;
            if(var11 <= 200L) {
         ...
         for(var9 = 0; var9 < 9; ++var9) {
            if(this.field_71474_y.field_151456_ac[var9].func_151468_f()) {
               this.field_71439_g.field_71071_by.field_70461_c = var9;
            }
         }

         var10 = this.field_71474_y.field_74343_n != EntityPlayer.EnumChatVisibility.HIDDEN;
         ...
         while(this.field_71474_y.field_74310_D.func_151468_f() && var10) {
            this.func_147108_a(new GuiChat());
         }

         if(this.field_71462_r == null && this.field_71474_y.field_74323_J.func_151468_f() && var10) {
            this.func_147108_a(new GuiChat("/"));
         }
   ...
   public void func_71371_a(String p_71371_1_, String p_71371_2_, WorldSettings p_71371_3_) {
      ...
      var12.func_150725_a(new C00Handshake(5, var11.toString(), 0, EnumConnectionState.LOGIN), new GenericFutureListener[0]);
   ...
   public void func_70000_a(PlayerUsageSnooper p_70000_1_) {
      ...
      while(var3.hasNext()) {
         ...
         p_70000_1_.func_152768_a("resource_pack[" + var2++ + "]", var4.func_110515_d());
      }
