...
public class PlayerControllerMP {
   ...
   public boolean func_78751_a(int p_78751_1_, int p_78751_2_, int p_78751_3_, int p_78751_4_) {
      if(this.field_78779_k.func_82752_c() && !this.field_78776_a.field_71439_g.func_82246_f(p_78751_1_, p_78751_2_, p_78751_3_)) {
         ...
         Block var6 = var5.func_147439_a(p_78751_1_, p_78751_2_, p_78751_3_);
         if(var6.func_149688_o() == Material.field_151579_a) {
            return false;
         } else {
            var5.func_72926_e(2001, p_78751_1_, p_78751_2_, p_78751_3_, Block.func_149682_b(var6) + (var5.func_72805_g(p_78751_1_, p_78751_2_, p_78751_3_) << 12));
            int var7 = var5.func_72805_g(p_78751_1_, p_78751_2_, p_78751_3_);
            boolean var8 = var5.func_147468_f(p_78751_1_, p_78751_2_, p_78751_3_);
            if(var8) {
               var6.func_149664_b(var5, p_78751_1_, p_78751_2_, p_78751_3_, var7);
            }
            ...
            if(!this.field_78779_k.func_77145_d()) {
               ...
               if(var9 != null) {
                  var9.func_150999_a(var5, var6, p_78751_1_, p_78751_2_, p_78751_3_, this.field_78776_a.field_71439_g);
   ...
   public void func_78743_b(int p_78743_1_, int p_78743_2_, int p_78743_3_, int p_78743_4_) {
      if(!this.field_78779_k.func_82752_c() || this.field_78776_a.field_71439_g.func_82246_f(p_78743_1_, p_78743_2_, p_78743_3_)) {
         if(this.field_78779_k.func_77145_d()) {
            ...
            this.field_78774_b.func_147297_a(new C07PacketPlayerDigging(0, p_78743_1_, p_78743_2_, p_78743_3_, p_78743_4_));
            Block var5 = this.field_78776_a.field_71441_e.func_147439_a(p_78743_1_, p_78743_2_, p_78743_3_);
            boolean var6 = var5.func_149688_o() != Material.field_151579_a;
            if(var6 && this.field_78770_f == 0.0F) {
               var5.func_149699_a(this.field_78776_a.field_71441_e, p_78743_1_, p_78743_2_, p_78743_3_, this.field_78776_a.field_71439_g);
            }

            if(var6 && var5.func_149737_a(this.field_78776_a.field_71439_g, this.field_78776_a.field_71439_g.field_70170_p, p_78743_1_, p_78743_2_, p_78743_3_) >= 1.0F) {
   ...
   public void func_78759_c(int p_78759_1_, int p_78759_2_, int p_78759_3_, int p_78759_4_) {
      ...
      if(this.field_78781_i > 0) {
         ...
         if(this.func_85182_a(p_78759_1_, p_78759_2_, p_78759_3_)) {
            Block var5 = this.field_78776_a.field_71441_e.func_147439_a(p_78759_1_, p_78759_2_, p_78759_3_);
            if(var5.func_149688_o() == Material.field_151579_a) {
               this.field_78778_j = false;
               return;
            }

            this.field_78770_f += var5.func_149737_a(this.field_78776_a.field_71439_g, this.field_78776_a.field_71439_g.field_70170_p, p_78759_1_, p_78759_2_, p_78759_3_);
            if(this.field_78780_h % 4.0F == 0.0F) {
               this.field_78776_a.func_147118_V().func_147682_a(new PositionedSoundRecord(new ResourceLocation(var5.field_149762_H.func_150498_e()), (var5.field_149762_H.func_150497_c() + 1.0F) / 8.0F, var5.field_149762_H.func_150494_d() * 0.5F, (float)p_78759_1_ + 0.5F, (float)p_78759_2_ + 0.5F, (float)p_78759_3_ + 0.5F));
            }
   ...
   private boolean func_85182_a(int p_85182_1_, int p_85182_2_, int p_85182_3_) {
      ...
      if(this.field_85183_f != null && var4 != null) {
         var5 = var4.func_77973_b() == this.field_85183_f.func_77973_b() && ItemStack.func_77970_a(var4, this.field_85183_f) && (var4.func_77984_f() || var4.func_77960_j() == this.field_85183_f.func_77960_j());
      }
   ...
   public boolean func_78760_a(EntityPlayer p_78760_1_, World p_78760_2_, ItemStack p_78760_3_, int p_78760_4_, int p_78760_5_, int p_78760_6_, int p_78760_7_, Vec3 p_78760_8_) {
      ...
      boolean var12 = false;
      if((!p_78760_1_.func_70093_af() || p_78760_1_.func_70694_bm() == null) && p_78760_2_.func_147439_a(p_78760_4_, p_78760_5_, p_78760_6_).func_149727_a(p_78760_2_, p_78760_4_, p_78760_5_, p_78760_6_, p_78760_1_, p_78760_7_, var9, var10, var11)) {
         var12 = true;
      }

      if(!var12 && p_78760_3_ != null && p_78760_3_.func_77973_b() instanceof ItemBlock) {
         ItemBlock var13 = (ItemBlock)p_78760_3_.func_77973_b();
         if(!var13.func_150936_a(p_78760_2_, p_78760_4_, p_78760_5_, p_78760_6_, p_78760_7_, p_78760_1_, p_78760_3_)) {
            return false;
         }
      }

      this.field_78774_b.func_147297_a(new C08PacketPlayerBlockPlacement(p_78760_4_, p_78760_5_, p_78760_6_, p_78760_7_, p_78760_1_.field_71071_by.func_70448_g(), var9, var10, var11));
      if(var12) {
         return true;
      } else if(p_78760_3_ == null) {
         return false;
      } else if(this.field_78779_k.func_77145_d()) {
         int var16 = p_78760_3_.func_77960_j();
