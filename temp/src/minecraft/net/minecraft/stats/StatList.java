   ...
   private static void func_75918_d() {
      ...
      while(var1.hasNext()) {
         ...
         if(var5 != null) {
            ...
            field_75928_D[var3] = (new StatCrafting("stat.craftItem." + var3, new ChatComponentTranslation("stat.craftItem", new Object[]{(new ItemStack(var5)).func_151000_E()}), var5)).func_75971_g();
         }
      }
      ...
      while(var0.hasNext()) {
         ...
         if(Item.func_150898_a(var1) != null) {
            ...
            if(var1.func_149652_G()) {
               field_75934_C[var2] = (new StatCrafting("stat.mineBlock." + var2, new ChatComponentTranslation("stat.mineBlock", new Object[]{(new ItemStack(var1)).func_151000_E()}), Item.func_150898_a(var1))).func_75971_g();
   ...
   private static void func_75925_c() {
      ...
      while(var0.hasNext()) {
         ...
         if(var1 != null) {
            ...
            field_75929_E[var2] = (new StatCrafting("stat.useItem." + var2, new ChatComponentTranslation("stat.useItem", new Object[]{(new ItemStack(var1)).func_151000_E()}), var1)).func_75971_g();
      ...
      while(var0.hasNext()) {
         ...
         if(var1 != null) {
            ...
            if(var1.func_77645_m()) {
               field_75930_F[var2] = (new StatCrafting("stat.breakItem." + var2, new ChatComponentTranslation("stat.breakItem", new Object[]{(new ItemStack(var1)).func_151000_E()}), var1)).func_75971_g();
            }
         }
      }
