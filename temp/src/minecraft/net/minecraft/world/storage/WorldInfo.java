...
public class WorldInfo {
   ...
   public WorldInfo(WorldSettings p_i2158_1_, String p_i2158_2_) {
      ...
      this.field_82576_c = "";
      this.field_82577_x = new GameRules();
      this.field_76100_a = p_i2158_1_.func_77160_d();
      this.field_76113_q = p_i2158_1_.func_77162_e();
      this.field_76112_r = p_i2158_1_.func_77164_g();
      this.field_76106_k = p_i2158_2_;
      this.field_76111_s = p_i2158_1_.func_77158_f();
      this.field_76098_b = p_i2158_1_.func_77165_h();
      this.field_82576_c = p_i2158_1_.func_82749_j();
      this.field_76110_t = p_i2158_1_.func_77163_i();
   ...
   public void func_85118_a(CrashReportCategory p_85118_1_) {
      ...
      p_85118_1_.func_71500_a("Level spawn location", new Callable() {
         ...
         public String call() {
            return CrashReportCategory.func_85071_a(WorldInfo.this.field_76099_c, WorldInfo.this.field_76096_d, WorldInfo.this.field_76097_e);
         }
         // $FF: synthetic method
         public Object call() {
            return this.call();
