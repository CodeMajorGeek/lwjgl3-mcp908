...
public class Chunk {
   ...
   public void func_76612_a(Entity p_76612_1_) {
      ...
      if(var2 != this.field_76635_g || var3 != this.field_76647_h) {
         field_150817_t.warn("Wrong location! " + p_76612_1_ + " (at " + var2 + ", " + var3 + " instead of " + this.field_76635_g + ", " + this.field_76647_h + ")");
         Thread.dumpStack();
      }
   ...
   public void func_76607_a(byte[] p_76607_1_, int p_76607_2_, int p_76607_3_, boolean p_76607_4_) {
      ...
      for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
         if((p_76607_2_ & 1 << var7) != 0 && this.field_76652_q[var7] != null) {
            var10 = this.field_76652_q[var7].func_76669_j();
            System.arraycopy(p_76607_1_, var5, var10.field_76585_a, 0, var10.field_76585_a.length);
            var5 += var10.field_76585_a.length;
         }
      }

      for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
         if((p_76607_2_ & 1 << var7) != 0 && this.field_76652_q[var7] != null) {
            var10 = this.field_76652_q[var7].func_76661_k();
            System.arraycopy(p_76607_1_, var5, var10.field_76585_a, 0, var10.field_76585_a.length);
            var5 += var10.field_76585_a.length;
         }
      }
      ...
      if(var6) {
         for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
            if((p_76607_2_ & 1 << var7) != 0 && this.field_76652_q[var7] != null) {
               var10 = this.field_76652_q[var7].func_76671_l();
               System.arraycopy(p_76607_1_, var5, var10.field_76585_a, 0, var10.field_76585_a.length);
               var5 += var10.field_76585_a.length;
            }
         }
      ...
      for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
         if((p_76607_3_ & 1 << var7) != 0) {
            if(this.field_76652_q[var7] == null) {
               ...
               var10 = this.field_76652_q[var7].func_76660_i();
               if(var10 == null) {
                  var10 = this.field_76652_q[var7].func_76667_m();
               }
