...
public class WorldGenBigTree extends WorldGenAbstractTree {
   ...
   void func_150529_a(int p_150529_1_, int p_150529_2_, int p_150529_3_, float p_150529_4_, byte p_150529_5_, Block p_150529_6_) {
      ...
      byte var8 = field_76507_a[p_150529_5_];
      byte var9 = field_76507_a[p_150529_5_ + 3];
         ...
         while(var13 <= var7) {
            ...
            if(var15 > (double)(p_150529_4_ * p_150529_4_)) {
               ...
               if(var14.func_149688_o() != Material.field_151579_a && var14.func_149688_o() != Material.field_151584_j) {
                  ...
                  this.func_150516_a(this.field_76506_c, var11[0], var11[1], var11[2], p_150529_6_, 0);
                  ++var13;
               }
            }
         }
   ...
   void func_76491_a(int p_76491_1_, int p_76491_2_, int p_76491_3_) {
      ...
      for(int var5 = p_76491_2_ + this.field_76508_n; var4 < var5; ++var4) {
         ...
         this.func_150529_a(p_76491_1_, var4, p_76491_3_, var6, (byte)1, Blocks.field_150362_t);
      }
   ...
   void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block p_150530_3_) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            var14[var6] = MathHelper.func_76128_c((double)(p_150530_1_[var6] + var15) + 0.5D);
            var14[var7] = MathHelper.func_76128_c((double)p_150530_1_[var7] + (double)var15 * var10 + 0.5D);
            var14[var8] = MathHelper.func_76128_c((double)p_150530_1_[var8] + (double)var15 * var12 + 0.5D);
            byte var17 = 0;
            ...
            this.func_150516_a(this.field_76506_c, var14[0], var14[1], var14[2], p_150530_3_, var17);
         }
