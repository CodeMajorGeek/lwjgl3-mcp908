...
public class MapGenRavine extends MapGenBase {
   ...
   protected void func_151540_a(long p_151540_1_, int p_151540_3_, int p_151540_4_, Block[] p_151540_5_, double p_151540_6_, double p_151540_8_, double p_151540_10_, float p_151540_12_, float p_151540_13_, float p_151540_14_, int p_151540_15_, int p_151540_16_, double p_151540_17_) {
      ...
      for(; p_151540_15_ < p_151540_16_; ++p_151540_15_) {
         double var54 = 1.5D + (double)(MathHelper.func_76126_a((float)p_151540_15_ * 3.1415927F / (float)p_151540_16_) * p_151540_12_ * 1.0F);
         double var30 = var54 * p_151540_17_;
         var54 *= (double)var19.nextFloat() * 0.25D + 0.75D;
         var30 *= (double)var19.nextFloat() * 0.25D + 0.75D;
         float var32 = MathHelper.func_76134_b(p_151540_14_);
         float var33 = MathHelper.func_76126_a(p_151540_14_);
         p_151540_6_ += (double)(MathHelper.func_76134_b(p_151540_13_) * var32);
         p_151540_8_ += (double)var33;
         p_151540_10_ += (double)(MathHelper.func_76126_a(p_151540_13_) * var32);
         p_151540_14_ *= 0.7F;
         ...
         if(var53 || var19.nextInt(4) != 0) {
            ...
            if(p_151540_6_ >= var20 - 16.0D - var54 * 2.0D && p_151540_10_ >= var22 - 16.0D - var54 * 2.0D && p_151540_6_ <= var20 + 16.0D + var54 * 2.0D && p_151540_10_ <= var22 + 16.0D + var54 * 2.0D) {
               int var55 = MathHelper.func_76128_c(p_151540_6_ - var54) - p_151540_3_ * 16 - 1;
               int var35 = MathHelper.func_76128_c(p_151540_6_ + var54) - p_151540_3_ * 16 + 1;
               int var56 = MathHelper.func_76128_c(p_151540_8_ - var30) - 1;
               int var37 = MathHelper.func_76128_c(p_151540_8_ + var30) + 1;
               int var57 = MathHelper.func_76128_c(p_151540_10_ - var54) - p_151540_4_ * 16 - 1;
               int var39 = MathHelper.func_76128_c(p_151540_10_ + var54) - p_151540_4_ * 16 + 1;
               if(var55 < 0) {
                  var55 = 0;
               }
                                 ...
                                 if(var52 == Blocks.field_150348_b || var52 == Blocks.field_150346_d || var52 == Blocks.field_150349_c) {
                                    if(var49 < 10) {
                                       ...
                                       if(var48 && p_151540_5_[var47 - 1] == Blocks.field_150346_d) {
                                          p_151540_5_[var47 - 1] = this.field_75039_c.func_72807_a(var41 + p_151540_3_ * 16, var44 + p_151540_4_ * 16).field_76752_A;
                                       }
                                    }
                                 }
                              }
   ...
   protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
      if(this.field_75038_b.nextInt(50) == 0) {
         double var7 = (double)(p_151538_2_ * 16 + this.field_75038_b.nextInt(16));
         double var9 = (double)(this.field_75038_b.nextInt(this.field_75038_b.nextInt(40) + 8) + 20);
         double var11 = (double)(p_151538_3_ * 16 + this.field_75038_b.nextInt(16));
         byte var13 = 1;
         ...
         for(int var14 = 0; var14 < var13; ++var14) {
            ...
            this.func_151540_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D);
         }
