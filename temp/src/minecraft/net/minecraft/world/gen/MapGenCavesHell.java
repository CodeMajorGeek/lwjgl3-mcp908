...
public class MapGenCavesHell extends MapGenBase {
   ...
   protected void func_151544_a(long p_151544_1_, int p_151544_3_, int p_151544_4_, Block[] p_151544_5_, double p_151544_6_, double p_151544_8_, double p_151544_10_) {
      this.func_151543_a(p_151544_1_, p_151544_3_, p_151544_4_, p_151544_5_, p_151544_6_, p_151544_8_, p_151544_10_, 1.0F + this.field_75038_b.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
   }
   ...
   protected void func_151543_a(long p_151543_1_, int p_151543_3_, int p_151543_4_, Block[] p_151543_5_, double p_151543_6_, double p_151543_8_, double p_151543_10_, float p_151543_12_, float p_151543_13_, float p_151543_14_, int p_151543_15_, int p_151543_16_, double p_151543_17_) {
      ...
      for(boolean var28 = var25.nextInt(6) == 0; p_151543_15_ < p_151543_16_; ++p_151543_15_) {
         double var29 = 1.5D + (double)(MathHelper.func_76126_a((float)p_151543_15_ * 3.1415927F / (float)p_151543_16_) * p_151543_12_ * 1.0F);
         double var31 = var29 * p_151543_17_;
         float var33 = MathHelper.func_76134_b(p_151543_14_);
         float var34 = MathHelper.func_76126_a(p_151543_14_);
         p_151543_6_ += (double)(MathHelper.func_76134_b(p_151543_13_) * var33);
         p_151543_8_ += (double)var34;
         p_151543_10_ += (double)(MathHelper.func_76126_a(p_151543_13_) * var33);
         if(var28) {
            p_151543_14_ *= 0.92F;
         } else {
            p_151543_14_ *= 0.7F;
         ...
         if(!var53 && p_151543_15_ == var27 && p_151543_12_ > 1.0F) {
            this.func_151543_a(var25.nextLong(), p_151543_3_, p_151543_4_, p_151543_5_, p_151543_6_, p_151543_8_, p_151543_10_, var25.nextFloat() * 0.5F + 0.5F, p_151543_13_ - 1.5707964F, p_151543_14_ / 3.0F, p_151543_15_, p_151543_16_, 1.0D);
            this.func_151543_a(var25.nextLong(), p_151543_3_, p_151543_4_, p_151543_5_, p_151543_6_, p_151543_8_, p_151543_10_, var25.nextFloat() * 0.5F + 0.5F, p_151543_13_ + 1.5707964F, p_151543_14_ / 3.0F, p_151543_15_, p_151543_16_, 1.0D);
            return;
         }
         ...
         if(var53 || var25.nextInt(4) != 0) {
            ...
            if(p_151543_6_ >= var19 - 16.0D - var29 * 2.0D && p_151543_10_ >= var21 - 16.0D - var29 * 2.0D && p_151543_6_ <= var19 + 16.0D + var29 * 2.0D && p_151543_10_ <= var21 + 16.0D + var29 * 2.0D) {
               int var54 = MathHelper.func_76128_c(p_151543_6_ - var29) - p_151543_3_ * 16 - 1;
               int var36 = MathHelper.func_76128_c(p_151543_6_ + var29) - p_151543_3_ * 16 + 1;
               int var55 = MathHelper.func_76128_c(p_151543_8_ - var31) - 1;
               int var38 = MathHelper.func_76128_c(p_151543_8_ + var31) + 1;
               int var56 = MathHelper.func_76128_c(p_151543_10_ - var29) - p_151543_4_ * 16 - 1;
               int var40 = MathHelper.func_76128_c(p_151543_10_ + var29) - p_151543_4_ * 16 + 1;
               if(var54 < 0) {
                  var54 = 0;
               }
   ...
   protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         double var9 = (double)(p_151538_2_ * 16 + this.field_75038_b.nextInt(16));
         double var11 = (double)this.field_75038_b.nextInt(128);
         double var13 = (double)(p_151538_3_ * 16 + this.field_75038_b.nextInt(16));
         int var15 = 1;
         if(this.field_75038_b.nextInt(4) == 0) {
            this.func_151544_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13);
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            this.func_151543_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13, var19 * 2.0F, var17, var18, 0, 0, 0.5D);
         }
      }
