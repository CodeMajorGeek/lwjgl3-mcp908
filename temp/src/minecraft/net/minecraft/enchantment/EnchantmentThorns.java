...
public class EnchantmentThorns extends Enchantment {
   ...
   public void func_151367_b(EntityLivingBase p_151367_1_, Entity p_151367_2_, int p_151367_3_) {
      Random var4 = p_151367_1_.func_70681_au();
      ItemStack var5 = EnchantmentHelper.func_92099_a(Enchantment.field_92091_k, p_151367_1_);
      if(func_92094_a(p_151367_3_, var4)) {
         p_151367_2_.func_70097_a(DamageSource.func_92087_a(p_151367_1_), (float)func_92095_b(p_151367_3_, var4));
         p_151367_2_.func_85030_a("damage.thorns", 0.5F, 1.0F);
         if(var5 != null) {
            var5.func_77972_a(3, p_151367_1_);
         }
      } else if(var5 != null) {
         var5.func_77972_a(1, p_151367_1_);
      }
