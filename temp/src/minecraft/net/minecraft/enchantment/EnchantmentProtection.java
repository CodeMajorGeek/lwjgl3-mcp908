...
public class EnchantmentProtection extends Enchantment {
   ...
   public int func_77318_a(int p_77318_1_, DamageSource p_77318_2_) {
      if(p_77318_2_.func_76357_e()) {
         ...
         return this.field_77356_a == 0?MathHelper.func_76141_d(var3 * 0.75F):(this.field_77356_a == 1 && p_77318_2_.func_76347_k()?MathHelper.func_76141_d(var3 * 1.25F):(this.field_77356_a == 2 && p_77318_2_ == DamageSource.field_76379_h?MathHelper.func_76141_d(var3 * 2.5F):(this.field_77356_a == 3 && p_77318_2_.func_94541_c()?MathHelper.func_76141_d(var3 * 1.5F):(this.field_77356_a == 4 && p_77318_2_.func_76352_a()?MathHelper.func_76141_d(var3 * 1.5F):0))));
      }
   }
   ...
   public static int func_92093_a(Entity p_92093_0_, int p_92093_1_) {
      int var2 = EnchantmentHelper.func_77511_a(Enchantment.field_77329_d.field_77352_x, p_92093_0_.func_70035_c());
      if(var2 > 0) {
         p_92093_1_ -= MathHelper.func_76141_d((float)p_92093_1_ * (float)var2 * 0.15F);
      }
   ...
   public static double func_92092_a(Entity p_92092_0_, double p_92092_1_) {
      int var3 = EnchantmentHelper.func_77511_a(Enchantment.field_77327_f.field_77352_x, p_92092_0_.func_70035_c());
      if(var3 > 0) {
         p_92092_1_ -= (double)MathHelper.func_76128_c(p_92092_1_ * (double)((float)var3 * 0.15F));
      }
