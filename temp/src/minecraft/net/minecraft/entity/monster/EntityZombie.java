...
public class EntityZombie extends EntityMob {
   ...
   public IEntityLivingData func_110161_a(IEntityLivingData p_110161_1_) {
      ...
      if(p_110161_1_1 instanceof EntityZombie.GroupData) {
         ...
         if(var3.field_142048_a) {
            ...
            if((double)this.field_70170_p.field_73012_v.nextFloat() < 0.05D) {
               List var4 = this.field_70170_p.func_82733_a(EntityChicken.class, this.field_70121_D.func_72314_b(5.0D, 3.0D, 5.0D), IEntitySelector.field_152785_b);
               if(!var4.isEmpty()) {
               ...
               var9.func_110161_a((IEntityLivingData)null);
      ...
      double var8 = this.field_70146_Z.nextDouble() * 1.5D * (double)this.field_70170_p.func_147462_b(this.field_70165_t, this.field_70163_u, this.field_70161_v);
      if(var8 > 1.0D) {
