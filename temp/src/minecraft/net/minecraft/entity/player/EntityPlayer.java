...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender {
   ...
   protected void func_71010_c(ItemStack p_71010_1_, int p_71010_2_) {
      ...
      if(p_71010_1_.func_77975_n() == EnumAction.eat) {
         for(int var3 = 0; var3 < p_71010_2_; ++var3) {
            Vec3 var4 = Vec3.func_72443_a(((double)this.field_70146_Z.nextFloat() - 0.5D) * 0.1D, Math.random() * 0.1D + 0.1D, 0.0D);
            var4.func_72440_a(-this.field_70125_A * 3.1415927F / 180.0F);
            var4.func_72442_b(-this.field_70177_z * 3.1415927F / 180.0F);
            Vec3 var5 = Vec3.func_72443_a(((double)this.field_70146_Z.nextFloat() - 0.5D) * 0.3D, (double)(-this.field_70146_Z.nextFloat()) * 0.6D - 0.3D, 0.6D);
   ...
   public EntityPlayer.EnumStatus func_71018_a(int p_71018_1_, int p_71018_2_, int p_71018_3_) {
      if(!this.field_70170_p.field_72995_K) {
         ...
         double var4 = 8.0D;
         double var6 = 5.0D;
         List var8 = this.field_70170_p.func_72872_a(EntityMob.class, AxisAlignedBB.func_72330_a((double)p_71018_1_ - var4, (double)p_71018_2_ - var6, (double)p_71018_3_ - var4, (double)p_71018_1_ + var4, (double)p_71018_2_ + var6, (double)p_71018_3_ + var4));
         if(!var8.isEmpty()) {
