...
public class InventoryPlayer implements IInventory {
   ...
   public int func_146027_a(Item p_146027_1_, int p_146027_2_) {
      ...
      for(var4 = 0; var4 < this.field_70462_a.length; ++var4) {
         ...
         if(var5 != null && (p_146027_1_ == null || var5.func_77973_b() == p_146027_1_) && (p_146027_2_ <= -1 || var5.func_77960_j() == p_146027_2_)) {
   ...
   public void func_70439_a(Item p_70439_1_, int p_70439_2_) {
      if(p_70439_1_ != null) {
         ...
         if(var3 >= 0) {
            ...
            this.field_70462_a[this.field_70461_c] = new ItemStack(p_70439_1_, var4, p_70439_2_);
         } else {
