...
public class EntityMinecartCommandBlock extends EntityMinecart {
   ...
   private final CommandBlockLogic field_145824_a = new CommandBlockLogic() {
      ...
      public ChunkCoordinates func_82114_b() {
         return new ChunkCoordinates(MathHelper.func_76128_c(EntityMinecartCommandBlock.this.field_70165_t), MathHelper.func_76128_c(EntityMinecartCommandBlock.this.field_70163_u + 0.5D), MathHelper.func_76128_c(EntityMinecartCommandBlock.this.field_70161_v));
      }
