   ...
   public void func_70636_d() {
      ...
      if(this.func_110143_aJ() <= 0.0F) {
         ...
         if(this.field_70170_p.field_72995_K) {
            ...
            Vec3 var15 = Vec3.func_72443_a(this.field_70980_b - this.field_70165_t, this.field_70981_c - this.field_70163_u, this.field_70978_d - this.field_70161_v).func_72432_b();
            Vec3 var39 = Vec3.func_72443_a((double)MathHelper.func_76126_a(this.field_70177_z * 3.1415927F / 180.0F), this.field_70181_x, (double)(-MathHelper.func_76134_b(this.field_70177_z * 3.1415927F / 180.0F))).func_72432_b();
         ...
         for(int var30 = 0; var30 < 3; ++var30) {
            ...
            float var36 = MathHelper.func_76126_a(var35);
            float var37 = MathHelper.func_76134_b(var35);
            float var38 = 1.5F;
            float var40 = (float)(var30 + 1) * 2.0F;
            var32.func_70071_h_();
            var32.func_70012_b(this.field_70165_t - (double)((var28 * var38 + var36 * var40) * var3), this.field_70163_u + (var34[1] - var29[1]) * 1.0D - (double)((var40 + var38) * var27) + 1.5D, this.field_70161_v + (double)((var7 * var38 + var37 * var40) * var3), 0.0F, 0.0F);
         }
