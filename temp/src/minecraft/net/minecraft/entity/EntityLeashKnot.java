...
public class EntityLeashKnot extends EntityHanging {
   ...
   public boolean func_130002_c(EntityPlayer p_130002_1_) {
      ...
      if(var2 != null && var2.func_77973_b() == Items.field_151058_ca && !this.field_70170_p.field_72995_K) {
         var4 = 7.0D;
         var6 = this.field_70170_p.func_72872_a(EntityLiving.class, AxisAlignedBB.func_72330_a(this.field_70165_t - var4, this.field_70163_u - var4, this.field_70161_v - var4, this.field_70165_t + var4, this.field_70163_u + var4, this.field_70161_v + var4));
         if(var6 != null) {
            var7 = var6.iterator();
   ...
   public static EntityLeashKnot func_110130_b(World p_110130_0_, int p_110130_1_, int p_110130_2_, int p_110130_3_) {
      List var4 = p_110130_0_.func_72872_a(EntityLeashKnot.class, AxisAlignedBB.func_72330_a((double)p_110130_1_ - 1.0D, (double)p_110130_2_ - 1.0D, (double)p_110130_3_ - 1.0D, (double)p_110130_1_ + 1.0D, (double)p_110130_2_ + 1.0D, (double)p_110130_3_ + 1.0D));
      if(var4 != null) {
