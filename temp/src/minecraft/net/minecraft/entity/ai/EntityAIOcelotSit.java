...
public class EntityAIOcelotSit extends EntityAIBase {
   ...
   private boolean func_151485_f() {
      ...
      for(int var4 = (int)this.field_151493_a.field_70165_t - 8; (double)var4 < this.field_151493_a.field_70165_t + 8.0D; ++var4) {
         for(int var5 = (int)this.field_151493_a.field_70161_v - 8; (double)var5 < this.field_151493_a.field_70161_v + 8.0D; ++var5) {
            if(this.func_151486_a(this.field_151493_a.field_70170_p, var4, var1, var5) && this.field_151493_a.field_70170_p.func_147437_c(var4, var1 + 1, var5)) {
   ...
   private boolean func_151486_a(World p_151486_1_, int p_151486_2_, int p_151486_3_, int p_151486_4_) {
      ...
      int var6 = p_151486_1_.func_72805_g(p_151486_2_, p_151486_3_, p_151486_4_);
