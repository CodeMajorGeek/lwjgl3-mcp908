...
public class EntityAIMoveTowardsTarget extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      ...
      if(this.field_75429_b == null) {
         ...
         Vec3 var1 = RandomPositionGenerator.func_75464_a(this.field_75431_a, 16, 7, Vec3.func_72443_a(this.field_75429_b.field_70165_t, this.field_75429_b.field_70163_u, this.field_75429_b.field_70161_v));
         if(var1 == null) {
            return false;
         } else {
