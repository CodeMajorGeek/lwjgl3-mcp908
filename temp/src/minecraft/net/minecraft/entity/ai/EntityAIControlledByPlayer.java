...
public class EntityAIControlledByPlayer extends EntityAIBase {
   ...
   public void func_75246_d() {
      ...
      if(this.field_82640_a.field_70122_E) {
         var8 = this.field_82640_a.field_70170_p.func_147439_a(MathHelper.func_76141_d((float)var4), MathHelper.func_76141_d((float)var5) - 1, MathHelper.func_76141_d((float)var6)).field_149765_K * 0.91F;
      }
      ...
      if(var4 != var17 || var6 != var18) {
         ...
         boolean var21 = !this.func_151498_a(var20) && (var20.func_149688_o() != Material.field_151579_a || !this.func_151498_a(this.field_82640_a.field_70170_p.func_147439_a(var4, var5 - 1, var6)));
         if(var21 && PathFinder.func_82565_a(this.field_82640_a, var17, var5, var18, var19, false, false, true) == 0 && PathFinder.func_82565_a(this.field_82640_a, var4, var5 + 1, var6, var19, false, false, true) == 1 && PathFinder.func_82565_a(this.field_82640_a, var17, var5 + 1, var18, var19, false, false, true) == 1) {
      ...
      if(!var1.field_71075_bZ.field_75098_d && this.field_82639_c >= this.field_82638_b * 0.5F && this.field_82640_a.func_70681_au().nextFloat() < 0.006F && !this.field_82636_d) {
         ItemStack var22 = var1.func_70694_bm();
         if(var22 != null && var22.func_77973_b() == Items.field_151146_bM) {
            var22.func_77972_a(1, var1);
            if(var22.field_77994_a == 0) {
               ItemStack var23 = new ItemStack(Items.field_151112_aM);
               var23.func_77982_d(var22.field_77990_d);
               var1.field_71071_by.field_70462_a[var1.field_71071_by.field_70461_c] = var23;
            }
         }
      }
