...
public abstract class EntityLivingBase extends Entity {
   ...
   public void func_70669_a(ItemStack p_70669_1_) {
      ...
      for(int var2 = 0; var2 < 5; ++var2) {
         Vec3 var3 = Vec3.func_72443_a(((double)this.field_70146_Z.nextFloat() - 0.5D) * 0.1D, Math.random() * 0.1D + 0.1D, 0.0D);
         var3.func_72440_a(-this.field_70125_A * 3.1415927F / 180.0F);
         var3.func_72442_b(-this.field_70177_z * 3.1415927F / 180.0F);
         Vec3 var4 = Vec3.func_72443_a(((double)this.field_70146_Z.nextFloat() - 0.5D) * 0.3D, (double)(-this.field_70146_Z.nextFloat()) * 0.6D - 0.3D, 0.6D);
