...
public class VillageDoorInfo {
   ...
   public VillageDoorInfo(int p_i1673_1_, int p_i1673_2_, int p_i1673_3_, int p_i1673_4_, int p_i1673_5_, int p_i1673_6_) {
      this.field_75481_a = p_i1673_1_;
      this.field_75479_b = p_i1673_2_;
      this.field_75480_c = p_i1673_3_;
      this.field_75477_d = p_i1673_4_;
      this.field_75478_e = p_i1673_5_;
      this.field_75475_f = p_i1673_6_;
   }
