...
public class VillageCollection extends WorldSavedData {
   ...
   public Village func_75550_a(int p_75550_1_, int p_75550_2_, int p_75550_3_, int p_75550_4_) {
      ...
      while(var7.hasNext()) {
         ...
         if(var9 < var6) {
            float var10 = (float)(p_75550_4_ + var8.func_75568_b());
            if(var9 <= var10 * var10) {
               var5 = var8;
               var6 = var9;
            }
   ...
   private void func_75542_c(int p_75542_1_, int p_75542_2_, int p_75542_3_) {
      int var4 = ((BlockDoor)Blocks.field_150466_ao).func_150013_e(this.field_75556_a, p_75542_1_, p_75542_2_, p_75542_3_);
      int var5;
      int var6;
      if(var4 != 0 && var4 != 2) {
         var5 = 0;
