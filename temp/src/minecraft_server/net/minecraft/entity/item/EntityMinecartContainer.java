      ...
      for(int var2 = 0; var2 < this.func_70302_i_(); ++var2) {
         ...
         if(var3 != null) {
            ...
            while(var3.field_77994_a > 0) {
               ...
               EntityItem var8 = new EntityItem(this.field_70170_p, this.field_70165_t + (double)var4, this.field_70163_u + (double)var5, this.field_70161_v + (double)var6, new ItemStack(var3.func_77973_b(), var7, var3.func_77960_j()));
               float var9 = 0.05F;
