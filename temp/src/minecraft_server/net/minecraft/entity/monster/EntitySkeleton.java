...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob {
   ...
   public void func_82196_d(EntityLivingBase p_82196_1_, float p_82196_2_) {
      EntityArrow var3 = new EntityArrow(this.field_70170_p, this, p_82196_1_, 1.6F, (float)(14 - this.field_70170_p.field_73013_u.func_151525_a() * 4));
      ...
      var3.func_70239_b((double)(p_82196_2_ * 2.0F) + this.field_70146_Z.nextGaussian() * 0.25D + (double)((float)this.field_70170_p.field_73013_u.func_151525_a() * 0.11F));
      if(var4 > 0) {
