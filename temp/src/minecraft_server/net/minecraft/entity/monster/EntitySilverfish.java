   ...
   protected void func_70626_be() {
      ...
      if(!this.field_70170_p.field_72995_K) {
                     ...
                     for(int var7 = 0; !var4 && var7 <= 10 && var7 >= -10; var7 = var7 <= 0?1 - var7:0 - var7) {
                        if(this.field_70170_p.func_147439_a(var1 + var6, var2 + var5, var3 + var7) == Blocks.field_150418_aU) {
                           if(!this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
                              ...
                              this.field_70170_p.func_147465_d(var1 + var6, var2 + var5, var3 + var7, (Block)var9.getLeft(), ((Integer)var9.getRight()).intValue(), 3);
                           } else {
         ...
         if(this.field_70789_a == null && !this.func_70781_l()) {
            ...
            var3 = MathHelper.func_76128_c(this.field_70161_v);
            int var10 = this.field_70146_Z.nextInt(6);
            Block var11 = this.field_70170_p.func_147439_a(var1 + Facing.field_71586_b[var10], var2 + Facing.field_71587_c[var10], var3 + Facing.field_71585_d[var10]);
            var6 = this.field_70170_p.func_72805_g(var1 + Facing.field_71586_b[var10], var2 + Facing.field_71587_c[var10], var3 + Facing.field_71585_d[var10]);
            if(BlockSilverfish.func_150196_a(var11)) {
               this.field_70170_p.func_147465_d(var1 + Facing.field_71586_b[var10], var2 + Facing.field_71587_c[var10], var3 + Facing.field_71585_d[var10], Blocks.field_150418_aU, BlockSilverfish.func_150195_a(var11, var6), 3);
               this.func_70656_aK();
               this.func_70106_y();
            } else {
               this.func_70779_j();
