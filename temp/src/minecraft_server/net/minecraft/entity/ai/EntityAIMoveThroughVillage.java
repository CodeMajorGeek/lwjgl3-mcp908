         ...
         if(var1 == null) {
            ...
            if(this.field_75416_d == null) {
               ...
               if(this.field_75419_c != null) {
                  ...
                  Vec3 var3 = RandomPositionGenerator.func_75464_a(this.field_75420_a, 10, 7, Vec3.func_72443_a((double)this.field_75416_d.field_75481_a, (double)this.field_75416_d.field_75479_b, (double)this.field_75416_d.field_75480_c));
                  if(var3 == null) {
                     return false;
                  } else {
                     this.field_75420_a.func_70661_as().func_75498_b(false);
