      ...
      if(p_71515_2_.length <= 0) {
         ...
         if(var5) {
            if(var7) {
               ...
               func_152373_a(p_71515_1_, this, "commands.xp.success.negative.levels", new Object[]{Integer.valueOf(var6), var3.func_70005_c_()});
            } else {
               var3.func_82242_a(var6);
               func_152373_a(p_71515_1_, this, "commands.xp.success.levels", new Object[]{Integer.valueOf(var6), var3.func_70005_c_()});
            }
         } else {
            if(var7) {
            ...
            func_152373_a(p_71515_1_, this, "commands.xp.success", new Object[]{Integer.valueOf(var6), var3.func_70005_c_()});
         }
