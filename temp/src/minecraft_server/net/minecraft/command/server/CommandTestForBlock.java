...
public class CommandTestForBlock extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length >= 4) {
         ...
         Block var6 = Block.func_149684_b(p_71515_2_[3]);
         if(var6 == null) {
            throw new NumberInvalidException("commands.setblock.notFound", new Object[]{p_71515_2_[3]});
         } else {
            int var7 = -1;
            if(p_71515_2_.length >= 5) {
               var7 = func_71532_a(p_71515_1_, p_71515_2_[4], -1, 15);
            }
            ...
            if(!var8.func_72899_e(var3, var4, var5)) {
               ...
               boolean var10 = false;
               if(p_71515_2_.length >= 6 && var6.func_149716_u()) {
                  String var11 = func_147178_a(p_71515_1_, p_71515_2_, 5).func_150260_c();
               ...
               if(var15 != var6) {
                  ...
                  if(var7 > -1) {
                     int var16 = var8.func_72805_g(var3, var4, var5);
                     if(var16 != var7) {
                  ...
                  p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.testforblock.success", new Object[]{Integer.valueOf(var3), Integer.valueOf(var4), Integer.valueOf(var5)}));
               }
            }
         }
      } else {
   ...
   public boolean func_147181_a(NBTBase p_147181_1_, NBTBase p_147181_2_) {
      if(p_147181_1_ == p_147181_2_) {
         ...
         do {
            ...
            var7 = var3.func_74781_a(var6);
         } while(this.func_147181_a(var7, var4.func_74781_a(var6)));
