...
public class ChunkProviderHell implements IChunkProvider {
   ...
   public void func_147419_a(int p_147419_1_, int p_147419_2_, Block[] p_147419_3_) {
      ...
      byte var7 = 17;
      int var8 = var4 + 1;
      this.field_73186_p = this.func_73164_a(this.field_73186_p, p_147419_1_ * var4, 0, p_147419_2_ * var4, var6, var7, var8);
   ...
   public void func_147418_b(int p_147418_1_, int p_147418_2_, Block[] p_147418_3_) {
      ...
      this.field_73185_q = this.field_73177_m.func_76304_a(this.field_73185_q, p_147418_1_ * 16, p_147418_2_ * 16, 0, 16, 16, 1, var5, var5, 1.0D);
      this.field_73184_r = this.field_73177_m.func_76304_a(this.field_73184_r, p_147418_1_ * 16, 109, p_147418_2_ * 16, 16, 1, 16, var5, 1.0D, var5);
      this.field_73183_s = this.field_73174_n.func_76304_a(this.field_73183_s, p_147418_1_ * 16, p_147418_2_ * 16, 0, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);
   ...
   public Chunk func_73154_d(int p_73154_1_, int p_73154_2_) {
      ...
      this.field_73182_t.func_151539_a(this, this.field_73175_o, p_73154_1_, p_73154_2_, var3);
      this.field_73172_c.func_151539_a(this, this.field_73175_o, p_73154_1_, p_73154_2_, var3);
   ...
   public void func_73153_a(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
      ...
      if(this.field_73181_i.nextInt(1) == 0) {
         ...
         var9 = var5 + this.field_73181_i.nextInt(16) + 8;
         (new WorldGenFlowers(Blocks.field_150338_P)).func_76484_a(this.field_73175_o, this.field_73181_i, var7, var8, var9);
      }
      ...
      if(this.field_73181_i.nextInt(1) == 0) {
         ...
         var8 = this.field_73181_i.nextInt(128);
         var9 = var5 + this.field_73181_i.nextInt(16) + 8;
         (new WorldGenFlowers(Blocks.field_150337_Q)).func_76484_a(this.field_73175_o, this.field_73181_i, var7, var8, var9);
      }
      ...
      for(var8 = 0; var8 < 16; ++var8) {
         ...
         var10 = this.field_73181_i.nextInt(108) + 10;
         var11 = var5 + this.field_73181_i.nextInt(16);
         (new WorldGenHellLava(Blocks.field_150356_k, true)).func_76484_a(this.field_73175_o, this.field_73181_i, var9, var10, var11);
      }
