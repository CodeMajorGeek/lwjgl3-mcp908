...
public class MapGenCaves extends MapGenBase {
   ...
   protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_) {
      ...
      for(boolean var28 = var25.nextInt(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_) {
         double var29 = 1.5D + (double)(MathHelper.func_76126_a((float)p_151541_15_ * 3.1415927F / (float)p_151541_16_) * p_151541_12_ * 1.0F);
         double var31 = var29 * p_151541_17_;
         float var33 = MathHelper.func_76134_b(p_151541_14_);
         float var34 = MathHelper.func_76126_a(p_151541_14_);
         p_151541_6_ += (double)(MathHelper.func_76134_b(p_151541_13_) * var33);
         p_151541_8_ += (double)var34;
         p_151541_10_ += (double)(MathHelper.func_76126_a(p_151541_13_) * var33);
         if(var28) {
            p_151541_14_ *= 0.92F;
         } else {
            p_151541_14_ *= 0.7F;
         ...
         if(!var54 && p_151541_15_ == var27 && p_151541_12_ > 1.0F && p_151541_16_ > 0) {
            this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, var25.nextFloat() * 0.5F + 0.5F, p_151541_13_ - 1.5707964F, p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
            this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, var25.nextFloat() * 0.5F + 0.5F, p_151541_13_ + 1.5707964F, p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
            return;
         }
         ...
         if(var54 || var25.nextInt(4) != 0) {
            ...
            if(p_151541_6_ >= var19 - 16.0D - var29 * 2.0D && p_151541_10_ >= var21 - 16.0D - var29 * 2.0D && p_151541_6_ <= var19 + 16.0D + var29 * 2.0D && p_151541_10_ <= var21 + 16.0D + var29 * 2.0D) {
               int var55 = MathHelper.func_76128_c(p_151541_6_ - var29) - p_151541_3_ * 16 - 1;
               int var36 = MathHelper.func_76128_c(p_151541_6_ + var29) - p_151541_3_ * 16 + 1;
               int var56 = MathHelper.func_76128_c(p_151541_8_ - var31) - 1;
               int var38 = MathHelper.func_76128_c(p_151541_8_ + var31) + 1;
               int var57 = MathHelper.func_76128_c(p_151541_10_ - var29) - p_151541_4_ * 16 - 1;
               int var40 = MathHelper.func_76128_c(p_151541_10_ + var29) - p_151541_4_ * 16 + 1;
               if(var55 < 0) {
                  var55 = 0;
               }
                                 ...
                                 if(var53 == Blocks.field_150348_b || var53 == Blocks.field_150346_d || var53 == Blocks.field_150349_c) {
                                    if(var50 < 10) {
                                       ...
                                       if(var49 && p_151541_5_[var48 - 1] == Blocks.field_150346_d) {
                                          p_151541_5_[var48 - 1] = this.field_75039_c.func_72807_a(var42 + p_151541_3_ * 16, var45 + p_151541_4_ * 16).field_76752_A;
                                       }
                                    }
                                 }
                              }
   ...
   protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         ...
         if(this.field_75038_b.nextInt(4) == 0) {
            this.func_151542_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13);
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            this.func_151541_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13, var19, var17, var18, 0, 0, 1.0D);
         }
      }
