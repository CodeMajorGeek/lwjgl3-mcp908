    ...
    static void func_151353_a()
    {
        ...
        BlockDispenser.field_149943_a.putObject(Items.boat, new BehaviorDefaultDispenseItem()
        {
            ...
            public ItemStack dispenseStack(IBlockSource p_82487_1_, ItemStack p_82487_2_)
            {
                ...
                {
                    if (!Material.air.equals(var14) || !Material.field_151586_h.equals(var4.getBlock(var11, var12 - 1, var13).getMaterial()))
                    {
        ...
        BlockDispenser.field_149943_a.putObject(Items.lava_bucket, var0);
        BlockDispenser.field_149943_a.putObject(Items.water_bucket, var0);
        ...
        BlockDispenser.field_149943_a.putObject(Item.getItemFromBlock(Blocks.tnt), new BehaviorDefaultDispenseItem()
        {
