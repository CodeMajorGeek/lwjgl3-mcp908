...
public class CommandSummon extends CommandBase
{
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        ...
        else
        {
            ...
            double var4 = (double)p_71515_1_.getCommandSenderPosition().posX + 0.5D;
            double var6 = (double)p_71515_1_.getCommandSenderPosition().posY;
            double var8 = (double)p_71515_1_.getCommandSenderPosition().posZ + 0.5D;
