...
public class CommandSetDefaultSpawnpoint extends CommandBase
{
    ...
    public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        if (p_71515_2_.length == 3)
        {
            ...
            p_71515_1_.getEntityWorld().func_72950_A(var4, var5, var6);
        ...
        else
        {
            ...
            ChunkCoordinates var8 = getCommandSenderAsPlayer(p_71515_1_).getCommandSenderPosition();
            p_71515_1_.getEntityWorld().func_72950_A(var8.posX, var8.posY, var8.posZ);
