...
public class BlockStairs extends Block
{
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        if (var7 == 0)
        {
            p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_, 2 | var8, 2);
        }

        if (var7 == 1)
        {
            p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_, 1 | var8, 2);
        }

        if (var7 == 2)
        {
            p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_, 3 | var8, 2);
        }

        if (var7 == 3)
        {
            p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_, 0 | var8, 2);
        }
    }
