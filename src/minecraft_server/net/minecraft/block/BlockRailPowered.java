...
public class BlockRailPowered extends BlockRailBase
{
    ...
    protected void func_150048_a(World p_150048_1_, int p_150048_2_, int p_150048_3_, int p_150048_4_, int p_150048_5_, int p_150048_6_, Block p_150048_7_)
    {
        ...
        {
            p_150048_1_.setBlockMetadata(p_150048_2_, p_150048_3_, p_150048_4_, p_150048_6_ | 8, 3);
            var9 = true;
        }
        else if (!var8 && (p_150048_5_ & 8) != 0)
        {
            p_150048_1_.setBlockMetadata(p_150048_2_, p_150048_3_, p_150048_4_, p_150048_6_, 3);
            var9 = true;
        }
