...
public class BlockCauldron extends Block
{
    ...
    {
        p_150024_1_.setBlockMetadata(p_150024_2_, p_150024_3_, p_150024_4_, MathHelper.clamp_int(p_150024_5_, 0, 3), 2);
    ...
    public void fillWithRain(World p_149639_1_, int p_149639_2_, int p_149639_3_, int p_149639_4_)
    {
        if (p_149639_1_.rand.nextInt(20) == 1)
        {
            ...
            if (var5 < 3)
            {
                p_149639_1_.setBlockMetadata(p_149639_2_, p_149639_3_, p_149639_4_, var5 + 1, 2);
            }
        }
    }
