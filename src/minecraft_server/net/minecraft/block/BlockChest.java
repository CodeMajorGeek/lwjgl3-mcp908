...
public class BlockChest extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_, var11, 3);
        }
        else
        {
            if ((var7 == this || var8 == this) && (var11 == 4 || var11 == 5))
            {
                if (var7 == this)
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_ - 1, var11, 3);
                }
                else
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_ + 1, var11, 3);
            ...
            if ((var9 == this || var10 == this) && (var11 == 2 || var11 == 3))
            {
                if (var9 == this)
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_ - 1, p_149689_3_, p_149689_4_, var11, 3);
                }
                else
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_ + 1, p_149689_3_, p_149689_4_, var11, 3);
    ...
    public void func_149954_e(World p_149954_1_, int p_149954_2_, int p_149954_3_, int p_149954_4_)
    {
        if (!p_149954_1_.isClient)
        {
            ...
            p_149954_1_.setBlockMetadata(p_149954_2_, p_149954_3_, p_149954_4_, var15, 3);
        }
    }
