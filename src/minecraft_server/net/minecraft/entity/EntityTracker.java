...
public class EntityTracker
{
    ...
    public void trackEntity(Entity p_72786_1_)
    {
        ...
        {
            this.trackEntity(p_72786_1_, 64, 5, true);
        }
        else if (p_72786_1_ instanceof EntityArrow)
        {
            this.trackEntity(p_72786_1_, 64, 20, false);
        }
        else if (p_72786_1_ instanceof EntitySmallFireball)
        {
            this.trackEntity(p_72786_1_, 64, 10, false);
        }
        ...
        {
            this.trackEntity(p_72786_1_, 64, 10, true);
        }
        ...
        {
            this.trackEntity(p_72786_1_, 64, 4, true);
        }
        ...
        {
            this.trackEntity(p_72786_1_, 64, 20, true);
        }
        else if (p_72786_1_ instanceof EntityMinecart)
        {
            this.trackEntity(p_72786_1_, 80, 3, true);
        }
        ...
        {
            this.trackEntity(p_72786_1_, 64, 3, true);
        }
        else if (p_72786_1_ instanceof EntityWither)
        {
            this.trackEntity(p_72786_1_, 80, 3, false);
        }
        ...
        {
            this.trackEntity(p_72786_1_, 160, 3, true);
        }
        else if (p_72786_1_ instanceof EntityTNTPrimed)
        {
            this.trackEntity(p_72786_1_, 160, 10, true);
        }
        else if (p_72786_1_ instanceof EntityFallingBlock)
        {
            this.trackEntity(p_72786_1_, 160, 20, true);
        }
        else if (p_72786_1_ instanceof EntityHanging)
        {
            this.trackEntity(p_72786_1_, 160, Integer.MAX_VALUE, false);
        }
        ...
        {
            this.trackEntity(p_72786_1_, 256, Integer.MAX_VALUE, false);
        }
    }

    public void trackEntity(Entity p_72791_1_, int p_72791_2_, int p_72791_3_)
    {
        this.trackEntity(p_72791_1_, p_72791_2_, p_72791_3_, false);
    }

    public void trackEntity(Entity p_72785_1_, int p_72785_2_, final int p_72785_3_, boolean p_72785_4_)
    {
