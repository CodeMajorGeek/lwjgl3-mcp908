...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob
{
    ...
    {
        EntityArrow var3 = new EntityArrow(this.worldObj, this, p_82196_1_, 1.6F, (float)(14 - this.worldObj.difficultySetting.func_151525_a() * 4));
        ...
        var3.setDamage((double)(p_82196_2_ * 2.0F) + this.rand.nextGaussian() * 0.25D + (double)((float)this.worldObj.difficultySetting.func_151525_a() * 0.11F));
