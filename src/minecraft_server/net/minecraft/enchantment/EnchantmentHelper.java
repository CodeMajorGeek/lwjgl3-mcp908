...
public class EnchantmentHelper
{
    ...
    public static void setEnchantments(Map p_82782_0_, ItemStack p_82782_1_)
    {
        ...
        while (var3.hasNext())
        {
            ...
            {
                Items.enchanted_book.addEnchantment(p_82782_1_, new EnchantmentData(var4, ((Integer)p_82782_0_.get(Integer.valueOf(var4))).intValue()));
            }
        }
    ...
    {
        return getMaxEnchantmentLevel(Enchantment.respiration.effectId, p_77501_0_.getInventory());
    }
