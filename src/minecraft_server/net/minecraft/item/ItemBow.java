...
public class ItemBow extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (var5 || p_77615_3_.inventory.func_146028_b(Items.arrow))
        {
            ...
            {
                p_77615_3_.inventory.func_146026_a(Items.arrow);
            }
    ...
    {
        if (p_77659_3_.capabilities.isCreativeMode || p_77659_3_.inventory.func_146028_b(Items.arrow))
        {
