...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public static void func_152321_a(GuiScreen p_152321_0_)
    {
        ...
        if (!OpenGlHelper.framebufferSupported)
        {
            ...
            var3.add(new ChatComponentTranslation("stream.unavailable.no_fbo.blend", new Object[] {Boolean.valueOf(Display.getCapabilities().GL_EXT_blend_func_separate)}));
            var3.add(new ChatComponentTranslation("stream.unavailable.no_fbo.arb", new Object[] {Boolean.valueOf(Display.getCapabilities().GL_ARB_framebuffer_object)}));
            var3.add(new ChatComponentTranslation("stream.unavailable.no_fbo.ext", new Object[] {Boolean.valueOf(Display.getCapabilities().GL_EXT_framebuffer_object)}));
