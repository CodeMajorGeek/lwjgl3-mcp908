...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	public GuiMainMenu() {
		...
		if (!Display.getCapabilities().OpenGL20 && !OpenGlHelper.func_153193_b()) {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2,
	...
	private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
		...
		GL11.glPushMatrix();
		GL11.glLoadIdentity();
		FloatBuffer matBf = BufferUtils.createFloatBuffer(16);
		new Matrix4f().setPerspective((float) Math.toRadians(120.F), 1.0F, 0.05F, 10.0F).get(matBf);
		GL11.glLoadMatrixf(matBf);
