...
public class OpenGlHelper
{
    ...
    {
        GLCapabilities var0 = Display.getCapabilities();
    ...
    public static void func_153169_a(int p_153169_0_, ByteBuffer var7)
    {
        if (field_153214_y)
        {
            ARBShaderObjects.glShaderSourceARB(p_153169_0_, var7.asCharBuffer());
        }
        else
        {
            GL20.glShaderSource(p_153169_0_, var7.asCharBuffer());
        }
    }
