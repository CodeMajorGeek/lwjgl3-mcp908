...
public class RenderGlobal implements IWorldAccess
{
    ...
    private void checkOcclusionQueryResult(int p_72720_1_, int p_72720_2_)
    {
        for (int var3 = p_72720_1_; var3 < p_72720_2_; ++var3)
        {
            ...
            {
                this.occlusionResult.clear();
                ARBOcclusionQuery.glGetQueryivARB(this.sortedWorldRenderers[var3].glOcclusionQuery, ARBOcclusionQuery.GL_QUERY_RESULT_AVAILABLE_ARB, this.occlusionResult);

                if (this.occlusionResult.get(0) != 0)
                {
                    this.sortedWorldRenderers[var3].isWaitingOnOcclusionQuery = false;
                    this.occlusionResult.clear();
                    ARBOcclusionQuery.glGetQueryivARB(this.sortedWorldRenderers[var3].glOcclusionQuery, ARBOcclusionQuery.GL_QUERY_RESULT_ARB, this.occlusionResult);
